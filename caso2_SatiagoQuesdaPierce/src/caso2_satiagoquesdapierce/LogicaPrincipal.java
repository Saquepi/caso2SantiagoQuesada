...
public class LogicaPrincipal {
    ...
    public void loadTrans(){
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[0].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[0].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[1].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[1].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[2].getPayed() != friends[i].getFN()){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[2].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[3].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[3].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[4].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[4].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[5].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[5].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[6].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[6].getDivided());
            }
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[6].getPayed() != friends[i].getFN() ){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[7].getDivided());
            }
    ...
    public void newTrans(){
        ...
        for (int i = 0; i < 6; i++) {
            if (debts[cCount].getPayed() != friends[i].getFN()){
                friends[i].setD2F(i, friends[i].getD2F(i)+debts[cCount].getDivided());
            }
